            ...
            <div>
                <div style={{ fontSize: 18, fontWeight: 'normal', color: '#141414', display:'flex', flexDirection:'column', marginTop:'27px', gap:'11px' }}>
                    ...
                    <CustomInput 
                        ...
                        placeholder={"문의 제목"} 
                        fontSize={18} 
                        value={inquiryData.questionTitle} 
                        disabled={true}
                    />
                </div>
                <div style={{ fontSize: 18, fontWeight: 'normal', color: '#141414', display:'flex', flexDirection:'column', marginTop:'27px', gap:'11px' }}>
                ...
                <div style={{ fontSize: 18, fontWeight: 'normal', color: '#141414', display:'flex', flexDirection:'column', marginTop:'27px', gap:'11px' }}>
                    이미지
                    <ImagePreview images={inquiryData.questionImages} /> 
                </div>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '30px' }}>
                        ...
                        <div style={{ fontSize: 18, fontWeight: 'normal', color: '#141414', display:'flex', flexDirection:'column', gap:'11px' }}>
                            ...
                            <CustomTextarea 
                                ...
                                placeholder={"답변 내용"} 
                                fontSize={18} 
                                value={inquiryData.answerContent || ''} 
                                disabled={true}
                            />
                        </div>
                        <div style={{ fontSize: 18, fontWeight: 'normal', color: '#141414', display:'flex', flexDirection:'column', gap:'11px' }}>
                            이미지
                            <ImagePreview images={inquiryData.answerImages || []} /> 
                        </div>
                    </div>
                )}
